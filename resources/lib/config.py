...
class config(object):
	def __init__(self):
		...
		self.listitem['sort_methods']['games'] = [xbmcplugin.SORT_METHOD_LABEL_IGNORE_THE,xbmcplugin.SORT_METHOD_TITLE_IGNORE_THE,xbmcplugin.SORT_METHOD_DATE,xbmcplugin.SORT_METHOD_GENRE,xbmcplugin.SORT_METHOD_STUDIO_IGNORE_THE,xbmcplugin.SORT_METHOD_SIZE,xbmcplugin.SORT_METHOD_LASTPLAYED,xbmcplugin.SORT_METHOD_PLAYCOUNT]
		...
		self.settings['game_select_action'] = dict() 
		self.settings['game_select_action']['options'] = dict(zip(['0','1','2','3'],['0','1','2','3']))
		self.settings['game_select_action']['default'] = '0'
		...
		self.settings['media_type_game']['listitem_type'] = dict(zip(['episodes','movies','games'],['video','video','game']))
		self.settings['media_type_game']['container_type'] = dict(zip(['episodes','movies','games'],['tvshows','sets','games']))  #Parent folder content type based on game content type set
		self.settings['media_type_game']['container_type_default'] = 'tvshows'
		...
		self.database['query']['favorites_by_all_no_page'] = ('SELECT * FROM (\n'
															...
															'UNION\n'
															'SELECT "search_from_link?query="||fav_table2.link_query as next_path,fav_table2.fav_link_name AS originaltitle,fav_table2.fav_link_name as label,fav_table2.fav_link_name as title,fav_table2.fav_link_name as sorttitle,"IAGL Search" as "set",fav_table2.fav_link_name as "tvshowtitle",NULL AS genre,NULL as studio,NULL AS date,NULL as premiered,NULL as year,NULL as mpaa,NULL as rating,NULL as tag,NULL as size,"IAGL Search Link[CR]"||fav_table2.fav_link_name as plot,NULL as country,NULL as trailer,NULL as lastplayed,NULL as playcount,"special://home/addons/plugin.program.iagl/assets/default/favorites_banner.png" as banner,"special://home/addons/plugin.program.iagl/assets/default/favorites_poster.png" as poster,"special://home/addons/plugin.program.iagl/assets/default/favorites_clearlogo.png" as clearlogo,"special://home/addons/plugin.program.iagl/assets/default/favorites_landscape.png" as landscape,"special://home/addons/plugin.program.iagl/assets/default/favorites_thumb.png" as thumb,"special://home/addons/plugin.program.iagl/fanart.png" as fanart,fav_table2.link_query as link_query\n'
															'FROM favorites as fav_table2\n'
															'WHERE fav_table2.is_search_link = 1\n'
															'UNION\n'
															'SELECT "random_from_link?query="||fav_table3.link_query as next_path,fav_table3.fav_link_name AS originaltitle,fav_table3.fav_link_name as label,fav_table3.fav_link_name as title,fav_table3.fav_link_name as sorttitle,"IAGL Random" as "set",fav_table3.fav_link_name as "tvshowtitle",NULL AS genre,NULL as studio,NULL AS date,NULL as premiered,NULL as year,NULL as mpaa,NULL as rating,NULL as tag,NULL as size,"IAGL Random Link[CR]"||fav_table3.fav_link_name as plot,NULL as country,NULL as trailer,NULL as lastplayed,NULL as playcount,"special://home/addons/plugin.program.iagl/assets/default/favorites_banner.png" as banner,"special://home/addons/plugin.program.iagl/assets/default/favorites_poster.png" as poster,"special://home/addons/plugin.program.iagl/assets/default/favorites_clearlogo.png" as clearlogo,"special://home/addons/plugin.program.iagl/assets/default/favorites_landscape.png" as landscape,"special://home/addons/plugin.program.iagl/assets/default/favorites_thumb.png" as thumb,"special://home/addons/plugin.program.iagl/fanart.png" as fanart,fav_table3.link_query as link_query\n'
		...
		self.database['query']['favorites_by_group'] = ('SELECT * FROM (\n'
														...
														'UNION\n'
														'SELECT fav_table2.fav_group as label,fav_table2.fav_group as next_path,"special://home/addons/plugin.program.iagl/assets/default/favorites_banner.png" as banner,"special://home/addons/plugin.program.iagl/assets/default/favorites_poster.png" as poster,"special://home/addons/plugin.program.iagl/assets/default/favorites_clearlogo.png" as clearlogo,"special://home/addons/plugin.program.iagl/assets/default/favorites_landscape.png" as landscape,"special://home/addons/plugin.program.iagl/assets/default/favorites_thumb.png" as thumb,"special://home/addons/plugin.program.iagl/fanart.png" as fanart\n'
														'FROM favorites as fav_table2\n'
														'WHERE fav_table2.is_search_link = 1\n'
														'GROUP BY fav_table2.fav_group\n'
														'UNION\n'
														'SELECT fav_table3.fav_group as label,fav_table3.fav_group as next_path,"special://home/addons/plugin.program.iagl/assets/default/favorites_banner.png" as banner,"special://home/addons/plugin.program.iagl/assets/default/favorites_poster.png" as poster,"special://home/addons/plugin.program.iagl/assets/default/favorites_clearlogo.png" as clearlogo,"special://home/addons/plugin.program.iagl/assets/default/favorites_landscape.png" as landscape,"special://home/addons/plugin.program.iagl/assets/default/favorites_thumb.png" as thumb,"special://home/addons/plugin.program.iagl/fanart.png" as fanart\n'
														'FROM favorites as fav_table3\n'
														'WHERE fav_table3.is_random_link = 1\n'
		...
		self.database['query']['search_random_images'] = ('SELECT NULL as next_path,"" as label,banner_paths.url||games_table.art_banner as banner,box_paths.url||games_table.art_box as poster,clearlogo_paths.url||games_table.art_logo as clearlogo,title_paths.url||games_table.art_title as landscape,snapshot_paths.url||games_table.art_snapshot as thumb,fanart_paths.url||games_table.art_fanart as fanart\n'
														'FROM games as games_table\n'
														'LEFT JOIN game_list as game_lists_table\n'
														'ON game_lists_table.label = games_table.game_list\n'
														'LEFT JOIN paths as banner_paths\n'
														...
														'ON fanart_paths."path" = games_table.art_fanart_path\n'
														'{game_search_query}\n'
														'AND (games_table.art_banner is not NULL OR games_table.art_box is not NULL OR games_table.art_logo is not NULL OR games_table.art_title is not NULL OR games_table.art_snapshot is not NULL OR games_table.art_title is not NULL OR games_table.art_snapshot is not NULL OR games_table.art_fanart is not NULL)\n'
